...
![Azure User Info](/assets/lab_images/image-3.png)

As you can see, the user's name 'Marcus Hutch' is shown along with some other info. But we want to get to sensitive info in the Azure environmet, so the first thing we should look for is more information on the resources attached to this account. To do that, there is another command in Azure AD:
